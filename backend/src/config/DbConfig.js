...
const AppDataSource = new DataSource({
    ...
    synchronize: true,
    logging: false,
    entities: [UserSchema, AreaDeTratamientoSchema, TurnoSchema, PasswordResetSchema, PersonalSchema, ListaEsperaSchema, TurnoAsignadoSchema, HistorialClinicoSchema, PagoSchema]
});
